"""API de capacidades y operaciones remotas individuales (M1.1, diseño §4).

Separado de favoritos/ignorados remotos (`admin_remote_flags.py`) y de
lotes (`admin_batches.py`) — mismo criterio de un archivo por recurso que ya
seguían esos dos (consolidación pre-M6, sin cambios de API).
"""
